...
const items: TimelineItemModel[] = [
  // {
  //   title: '20 - Fevereiro - 1981',
  //   cardTitle: 'Edgar Bonfim Junior',
  //   url: '#',
  //   media: {
  //     name: 'Edgar Bonfim Junior',
  //     source: {
  //       url: 'http://192.168.1.141:4444/imagens/foto_nascimento.jpeg',
  //     },
  //     type: 'IMAGE',
  //   },
  //   cardSubtitle:
  //     'Nascido em Belo Horizonte no dia 20 de fevereiro de 1981',
  //   cardDetailedText: [
  //     ``,
  //     ` <ul>
  //         <li>Filho de Edgar Bonfim e Neuza Marcil Carneiro Bonfim</li>
  //         <li>5 Irmãos</li>
  //         <li>Casado</li>
  //         <li>Uma filha</li>
  //       </ul>
    ...
    items: [
      {
        ...
        cardDetailedText: `Filho de Edgar Bonfim e Neuza Marcil Carneiro Bonfim. Nascido em Belo Horizonte no dia 20 de fevereiro de 1981`,
      },
      {
        cardTitle: 'Pais e Irmãos',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/pais-irmaos-2.png',
          },
          type: 'IMAGE',
        },
      },
      {
        cardTitle: 'Esposa e filha',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/esposa-filha.png',
          },
          type: 'IMAGE',
        },
      },
      {
        ...
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/cecilia.png',
          },
          type: 'IMAGE',
        },
      },
  ...
  {
    title: 'Meados de 1987',
    items: [
      {
        cardTitle: 'Mudança de cidade para o interior da BA',
        url: 'http://www.google.com',
        media: {
          name: 'Tanque Novo - BA',
          source: {
            url: 'http://192.168.1.141:4444/imagens/tanque-novo-ba.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: `Brincadeiras - Os primeiros contatos com o futebol `,
      },

      {
        ...
        url: 'http://www.google.com',
        media: {
          name: 'Volta para Betim - MG',
          source: {
            url: 'http://192.168.1.141:4444/imagens/betim-mg.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: `
        <ul>
          <li>Volta para Betim - MG</li>
          <li>Infância, Primos e amigos</li>
        </ul>
        `,
      },
    ],
  ...
  {
    title: 'Bug do milénio',
    items: [
      {
        cardTitle: 'Não precisa testar ',
        url: 'http://www.google.com',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/bug-do-milenio.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
      ...
      {
        cardTitle: 'Primeiro contato com o computador',
        url: 'http://www.google.com',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/computador.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `
        <ul>
          <li>De 1999 até 2003</li>
          <li>Pentium 166 MMX - 14" - Kit multimidia</li>
          <li>Curso de Delphi</li>
          <li>Faculdade Sistema de informação - PUC Minas</li>
          <li>C++</li>
          <li>Sistema para locadora</li>
        </ul>
        `,
        
      },
      {
        cardTitle: 'Trabalhondo com meu pai',
        url: 'http://www.google.com',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/estrutura.png',
          },
          type: 'IMAGE',
        },
        cardSubtitle:
        'Trabalho pesado mas muito gratificante ',
        cardDetailedText: 
        `
        `,
      },
...

  {
    ...
    items: [
      {
        cardTitle: 'Cruzeiro Esporte Clube',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/triplice.png',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        ` "O Cruzeiro conquistou a Tríplice Coroa em 2003. O Cruzeiro foi o primeiro clube brasileiro a conquistar a Tríplice Coroa, que consiste em vencer o Torneio Nacional, a Copa Nacional e o Campeonato Estadual na mesma temporada."
        `,
      },
      {
        cardTitle: 'Tribo Lan HOuse',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/tribo.png',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `
        <ul>
          <li>De 2003 até 2006</li>
          <li>35 Computadores</li>
          <li>Rede - Domínio Windows Server</li>
        </ul>
        `,
      },
      {
        cardTitle: 'Petrovila Combustíveis, Postos Vila, Petrovila Logística',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/grupo-villa.png',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `
        <ul>
          <li>De 2007 até 2010</li>
          <li>95 Computadores distribuídos em 3 filiais</li>
          <li>Rede - Domínio Windows Server</li>
          <li>Implementação – Globus - ERP de transporte desenvolvido pela BGMRodotec,</li>
          <li>Implementação Nota Fiscal eletrônica</li>
          <li>Estagnação na área de rede e manutenção de computadores</li>
        </ul>
        `,
      },
...

  {
    ...
    items: [
      {
        cardTitle: 'Virada de chave',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/virada-chave.png',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        ` Foi um momento em que me encontrava estagnado - (Que se encontra em estado estacionário, que não progride; parado, paralisado.)
        <ul>
          <li>De 2010 até 2012</li>
          <li>Começei a ter tempo para estudar programação</li>
          <li>Começei a dedicar ao que realmente queria fazer</li>
        </ul>
        `,
      },

      {
        cardTitle: 'PEB Comunicação',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/peb.png',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `Neste período aprendi bastante e me desenvolvi como programador!
        <ul>
          <li>De 2012 até 2022 ( Presencial )</li>
          <li>Começei a trabalhar com desenvolvimento</li>
          <li>Web sites</li>
          <li>Sitemas online</li>
          <li>Mobile</li>
        </ul>
        `,
      },
      ...
      {
        cardTitle: 'B2 Finance',
        url: '#',
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/b2.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `Foi um momento que tive o incentivo da minha esposa para poder sair da zona de conforto e ir atrás de novos desafios!
        <ul>
          <li>De 2022 até hoje</li>
          <li>Trabalhar em casa ( 100% remoto )</li>
          <li>Sitemas online</li>
          <li>* Mobile</li>
        </ul>
        `,
      },
      {
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/img01.jpeg',
          },
          type: 'IMAGE',
        },
      },
      {
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/img02.jpeg',
          },
          type: 'IMAGE',
        },
        cardDetailedText: 
        `Obs.: Não tenho fotos com todos para colocar aqui! 
        `,
      },
    ...
    items: [
      {
        ...
        media: {
          name: 'img',
          source: {
            url: 'http://192.168.1.141:4444/imagens/consideracoes.png',
          },
          type: 'IMAGE',
        },
        cardTitle: 'Quem é o próximo da fila?',
      },
